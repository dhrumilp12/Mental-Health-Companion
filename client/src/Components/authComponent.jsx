                                ...
                                <form onSubmit={handleSignUp}>
                                    ...
                                    >
                                        <Typography
                                            ...
                                            gutterBottom
                                        >
                                            Select any mental stressors you are
                                            currently experiencing to help us
                                            better tailor your therapy sessions.
                                        </Typography>
                                        {mentalStressors.map((stressor) => (
                                            <FormControlLabel
                                                ...
                                                control={
                                                    <Checkbox
                                                        checked={selectedStressors.includes(
                                                            stressor.id
                                                        )}
                                                        onChange={
